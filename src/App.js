...
function App() {
  ...
  return (
     <div className="App bg-blue-900 h-screen w-screen relative overflow-hidden flex justify-center items-center">
      ...
      <div className="h-35-r w-35-r bg-gradient-to-r from-pink-400 via-pink-500 to-red-500 rounded-full absolute top-96 -left-20 transform rotate-180 animate-pulse"></div>
      <Tilt>
